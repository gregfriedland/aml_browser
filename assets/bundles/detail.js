...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Patient = React.createClass({
	    ...
	    componentDidMount: function () {
	        ...
	        setInterval(this.loadOnePatientFromServer, this.props.pollInterval);
	    },
	    render: function () {
	        if (this.state.data) {
	            console.log('DATA!');
	...
	ReactDOM.render(React.createElement(Patient, { url: patient_url, pollInterval: 10000 }), document.getElementById('container'));
