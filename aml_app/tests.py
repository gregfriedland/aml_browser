...
class AccountTests(APITestCase):
    def setUp(self):
        ...
        Patient.objects.create(patient_id="3001", gender="male")
    ...
    def test_patients_api(self):
        ...
        self.assertEqual(resp.data,
            [{'patient_id': '2000', 'gender': 'female', 'ethnicity': '', 'platelet_result_count': '', 'vital_status': '', 'id': 1},
             {'patient_id': '2001', 'gender': 'male', 'ethnicity': '', 'platelet_result_count': '', 'vital_status': '', 'id': 2},
             {'patient_id': '3001', 'gender': 'male', 'ethnicity': '', 'platelet_result_count': '', 'vital_status': '', 'id': 3}])
    ...
    def test_detail_api(self):
        ...
        resp = self.client.get('/aml/patient/5/v1')
        self.assertEqual(resp.data, {'detail': 'Not found.'})

    def test_search_api(self):
        resp = self.client.get('/aml/search/200/v1')
        self.assertEqual(resp.data,
            [{'patient_id': '2000', 'gender': 'female', 'ethnicity': '', 'platelet_result_count': '', 'vital_status': '', 'id': 1},
             {'patient_id': '2001', 'gender': 'male', 'ethnicity': '', 'platelet_result_count': '', 'vital_status': '', 'id': 2}])